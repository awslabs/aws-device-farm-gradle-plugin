...
/**
 * App explorer test, may provide credentials to use if app requests log in.
 */
class AppExplorerTest extends ConfiguredTest {
    ...
    void username(String val) { username = val }
