...
class UiAutomatorTest extends ConfiguredTest implements TestPackageProvider, HasFilter {

    {
        testType = TestType.UIAUTOMATOR
        this.testPackageUploadType = UploadType.UIAUTOMATOR_TEST_PACKAGE
    }
